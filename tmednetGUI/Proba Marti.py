...
df = pd.read_excel('/home/marcjou/Documentos/PalazzuPopulationEvolution.xlsx', sheet_name='Conjunt Transectes')
...
#ax = df.plot.barh(x='Trans+Col', y='Mortality_year', color=color)
ax = sns.barplot(data=dfy, x='Mortality_year', y='Trans+Col', hue='KM', orient='h')
